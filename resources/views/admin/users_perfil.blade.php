      ...
      <div class="row">
          ...
          <div class="col-sm-4">
              ...
              <div class="box box-solid" style="padding:20px;height: 180px; box-shadow: 0 0 1px rgba(0,0,0,.125),0 1px 3px rgba(0,0,0,.2); border-radius: 25px;">
                  ...
                  <div class="row">
              <div class="col-md-3">
                  <img src="https://cravatar.eu/helmavatar/<?php echo $user_perfil->nick;?>/190.png" style="margin-right: 10px;width: 80px;">
              </div> 
              <div class="col-md-9">
                  <div class="row">
                      <a href="#" class="d-block" style="color:black;font-size: 2em;"> [ <b id="rango"></b> ]  <?php echo $user_perfil->nick;?></a>
                  </div> 
              ...
              <div class="col-sm-4">
                  <div class="box box-solid">
                      <div class="box-header with-border">
                          <h3 class="box-title"><b>SUBSCRIPCIONES ACTIVAS</b></h3>
...
<script>
       ...
       // var cinta_permisos = document.getElementById("cinta_rango");
        ...
        var user_id = '<?php echo $user_perfil->id;?>';
        var pedidos_texto = "";
